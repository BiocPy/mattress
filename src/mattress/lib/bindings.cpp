...
PYAPI void py_extract_column(void* rawmat, int c, double* output, int32_t* errcode, char** errmsg) {
    try {
...
PYAPI void py_extract_row(void* rawmat, int r, double* output, int32_t* errcode, char** errmsg) {
    try {
...
PYAPI void* py_initialize_compressed_sparse_matrix(int nr, int nc, uint64_t nz, const char* dtype, void* dptr, const char* itype, void* iptr, void* indptr, uint8_t byrow, int32_t* errcode, char** errmsg) {
    void* output = NULL;
    try {
...
PYAPI void* py_initialize_dense_matrix(int nr, int nc, const char* type, void* ptr, uint8_t byrow, int32_t* errcode, char** errmsg) {
    void* output = NULL;
    try {
