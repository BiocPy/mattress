...
def compute_column_medians_by_group(rawmat, grouping, output, num_threads):
    return _catch_errors(lib.py_compute_column_medians_by_group)(
        rawmat, grouping, output, num_threads
    )
...
def compute_column_ranges(rawmat, min_output, max_output, num_threads):
    return _catch_errors(lib.py_compute_column_ranges)(
...
def compute_column_sums_by_group(rawmat, grouping, output, num_threads):
    return _catch_errors(lib.py_compute_column_sums_by_group)(
        rawmat, grouping, output, num_threads
    )
...
def compute_row_medians_by_group(rawmat, grouping, output, num_threads):
    return _catch_errors(lib.py_compute_row_medians_by_group)(
        rawmat, grouping, output, num_threads
    )
...
def compute_row_ranges(rawmat, min_output, max_output, num_threads):
    return _catch_errors(lib.py_compute_row_ranges)(
        rawmat, min_output, max_output, num_threads
    )
...
def compute_row_sums_by_group(rawmat, grouping, output, num_threads):
    return _catch_errors(lib.py_compute_row_sums_by_group)(
        rawmat, grouping, output, num_threads
    )
...
def initialize_compressed_sparse_matrix(
    ...
    return _catch_errors(lib.py_initialize_compressed_sparse_matrix)(
        nr, nc, nz, dtype, dptr, itype, iptr, indptr, byrow
    )
...
def initialize_delayed_subset(ptr, dim, subset, len):
    return _catch_errors(lib.py_initialize_delayed_subset)(
        ptr, dim, _np2ct(subset, np.int32), len
    )
...
def initialize_delayed_unary_isometric_op_with_scalar(ptr, op, right, arg):
    return _catch_errors(lib.py_initialize_delayed_unary_isometric_op_with_scalar)(
        ptr, op, right, arg
    )


def initialize_delayed_unary_isometric_op_with_vector(ptr, op, right, along, args):
    return _catch_errors(lib.py_initialize_delayed_unary_isometric_op_with_vector)(
        ptr, op, right, along, _np2ct(args, np.float64)
    )
